...
type Suite struct {
	...
	t          *testing.T
	limit      Limit
	newStorage storage.StorageFactory
}
...
func (s *Consistency) Run(t *testing.T, factory storage.StorageFactory) {
	s.t = t
...
func (s *ConsistencyWithMeta) Run(t *testing.T, factory storage.StorageFactory) {
	s.t = t
	s.newStorage = factory
	suite.Run(t, s)
}
...
func (s *Concurrency) Run(t *testing.T, factory func() storage.Storage) {
	s.t = t
	s.newStorage = factory
	suite.Run(t, s)
}
...
func (s *FailureRate) Run(t *testing.T, factory func() storage.Storage, limit Limit) {
	// reduce logging
